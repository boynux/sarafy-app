...
public class ExchangeRateContract {
	...
	public boolean updateExchangeRate(String cat, String title,
		...
		values.put(ExchangeEntry.COLUMN_NAME_VALUE1, commodityValues[0]);
		values.put(ExchangeEntry.COLUMN_NAME_VALUE2, commodityValues[1]);
		values.put(ExchangeEntry.COLUMN_NAME_VALUE3, commodityValues[2]);
