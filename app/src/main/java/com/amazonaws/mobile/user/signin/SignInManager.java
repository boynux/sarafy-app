...
public class SignInManager {
     ...
     */
    public SignInManager(final Context context) {
     ...
     * @return instance
     */
    public synchronized static SignInManager getSignInProviderManager() {
        return singleton;
    }
    ...
    public void initializeSignInButton(final Class<? extends SignInProvider> providerClass,
        ...
        provider.initializeSignInButton(resultsAdapter.getActivity(),
                buttonView,
